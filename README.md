...
```shell
gource --highlight-users -1280x720 -o - | ffmpeg -y -r 60 -f image2pipe -vcodec ppm -i - -vcodec h264_videotoolbox -preset slower -pix_fmt yuv420p -crf 1 -threads 0 -bf 0 gource.mp4
```
